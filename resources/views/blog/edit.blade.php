                        ...
                        <div class="card-body">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-4 mg-t-10 mg-lg-t-0">
                                    ...
                                    <input  class="form-control"  v-model='image' name="image" placeholder=".... " type="file">
                                </div>
                                <div class="col-lg-4 mg-t-10 mg-lg-t-0">
                                    <label class="form-label"> الوصف </label>
                                    <textarea required="" class="form-control" v-model='desc' name="desc"  >{{$type->desc}}</textarea>
                                </div>
                            </div>
        ...
        content = new Vue({
            ...
            methods: {
                ...
                saveData: function(e) {
                    ...
                    axios.post('{{ route('blog.update') }}', formData).then(response => {
