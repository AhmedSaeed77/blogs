...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> فصل  </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                ...
                                <table class="table text-md-nowrap" id="type">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wd border-bottom-0">  الصف   </th>
                                            <th class="wd border-bottom-0">  المرحله   </th>
        ...
        content = new Vue({
            ...
            methods: {
                ...
                saveData: function(e) {
                    ...
                    this.load = true;
                    axios.post('{{ route('level.store') }}', formData).then(response => {
