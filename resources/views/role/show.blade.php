...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal1">اضافه صلاحيه جديد</button>
<br><br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            @foreach(config('global.permissions') as $name => $value)
                                                ...
                                                <input type="checkbox"  name="permissions[]" value="{{ $name }}" {{in_array($name, $role->permissions) ? 'checked' : '' }}><br>
                                            @endforeach    
                                        </div>
                                    </div>
                                    <br><br>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('role.delete', 'test') }}" method="post">
                                    @csrf
                                    هل تريد حذف الصلاحيه   {{ $role->name }} ؟؟
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  action="{{route('role.store')}}" method="POST" class="needs-validation was-validated"  id="createType">
                        @csrf
                        <div class="row">
                            <div class="col">
                                <label for="Name" class="mr-sm-2">الاسم:</label>
                            ...
                            <div class="col">
                                ...
                                @foreach(config('global.permissions') as $name => $value)
                                    <label for="exampleFormControlTextarea1">{{ $name }}</label>
                                    <input type="checkbox"  name="permissions[]" value="{{ $name }}" ><br>
                                @endforeach
