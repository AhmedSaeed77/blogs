...
@csrf
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" value="{{old('auth')}}" 
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" value="{{old('content')}}" name="content" 
  ...
  <div class="form-group">
    ...
    <input type="file" class="form-control" value="{{old('photo')}}" name="image" required>
    @if ($errors->any())
